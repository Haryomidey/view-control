...
router.post('/', asyncHandler(async (req, res) => {
  ...
  await ensureProjectAccess(req.user._id, projectId);
...
router.patch('/:controlId', asyncHandler(async (req, res) => {
  const control = await Control.findOneAndUpdate(
    { _id: req.params.controlId, ownerId: req.user._id },
    { $set: req.body },
...
router.delete('/:controlId', asyncHandler(async (req, res) => {
  const control = await Control.findOneAndDelete({ _id: req.params.controlId, ownerId: req.user._id });
