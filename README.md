...
```html
<script
  src="https://view-control-production.up.railway.app/cdn/viewcontrol.js"
  data-project-id="vc_your_project_key"
  data-api-url="https://view-control-production.up.railway.app"
  data-debug="false"
  async
></script>
```
...
- `VIEWCONTROL_API_URL`: production value is `https://view-control-production.up.railway.app`
...
PUBLIC_API_URL=https://view-control-production.up.railway.app
RUNTIME_CDN_URL=https://view-control-production.up.railway.app/cdn/viewcontrol.js
```

For the dashboard install snippets, you can also define Vite env variables:

```env
VITE_VIEWCONTROL_API_URL=https://view-control-production.up.railway.app
VITE_VIEWCONTROL_CDN_URL=https://view-control-production.up.railway.app/cdn/viewcontrol.js
```
...
```txt
https://view-control-production.up.railway.app/cdn/viewcontrol.js
```
